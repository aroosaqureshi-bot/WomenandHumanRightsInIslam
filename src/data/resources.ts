...
export const resources: Resource[] = [
  ...
  {
    id: 'r7',
    title: 'Al-Azhar Al-Sharif',
    titleUrdu: 'الازہر الشریف',
    description: 'The oldest and most respected center of Islamic learning and scholarship in the world.',
    descriptionUrdu: 'دنیا کا قدیم اور سب سے معتبر اسلامی تعلیم اور علمی مرکز۔',
    type: 'Organization',
    icon: 'Library',
    url: 'https://www.alazhar.gov.eg',
  },
  {
    id: 'r8',
    title: 'Muslim World League',
    titleUrdu: 'مسلم ورلڈ لیگ',
    description: 'An international NGO promoting Islamic values, human rights, and interfaith cooperation.',
    descriptionUrdu: 'اسلامی اقدار، انسانی حقوق، اور بین المذاہب تعاون کو فروغ دینے والی بین الاقوامی تنظیم۔',
    type: 'Organization',
    icon: 'Globe',
  ...
  },
  {
    ...
    titleUrdu: 'یقین انسٹیٹیوٹ',
    description: 'Research institute producing evidence-based content on Islam, women\u2019s rights, and modern questions.',
    descriptionUrdu: 'اسلام، خواتین حقوق، اور جدید سوالات پر شواہد پر مبنی مواد تیار کرنے والا تحقیقی ادارہ۔',
    type: 'Organization',
    icon: 'Sparkles',
