...
export default function SearchModal({ open, onClose, onNavigate }: SearchModalProps) {
  ...
  const items: SearchItem[] = useMemo(() => {
    ...
    const pages = [
      ...
      { id: 'quiz', title: 'Know Your Rights Quiz', titleUrdu: 'اپنے حقوق جانیں کوئز', snippet: 'Test your knowledge with 10 questions on Islamic rights, with explanations.', snippetUrdu: 'اسلامی حقوق پر ۱۰ سوالات کے ساتھ اپنا علم آزمائیں، وضاحت کے ساتھ۔', page: 'quiz' },
